...
<body>
        ...
        <section class="carousel">
            <div class="col-md-6">
                <div class="thumbnail">
                    <img src="pic/IP.jpg" style="width:100%">
                    <div class="caption">
                        <h4 class="pull-right">P210,900</h4>
                        <h4><a href="product1.php">IPHONE 15 PRO MAX</a></h4>
            ...
            <div class="col-md-6 col-md-offset-0">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item">
                        <img src="pic/ip2.jpg" height="150">
                    </div>
                    <div class="item">
                        <img src="pic/ip3.jpg" height="150">
                    </div>
                </div>
