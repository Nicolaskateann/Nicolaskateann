...
<body>
        ...
        <section class="carousel">
            <div class="col-md-6">
                <div class="thumbnail">
                    <img src="pic/S22.jpg" style="width:100%">
                    <div class="caption">
                        <h4 class="pull-right">P20,900</h4>
                        <h4><a href="product1.php">Samsung S22</a></h4>
            ...
            <div class="col-md-6 col-md-offset-0">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item">
                        <img src="pic/ss3.png" height="150">
                    </div>
                    <div class="item">
                        <img src="pic/ss1.jpg" height="150">
                    </div>
                </div>
                ...
                <div class="list-group-item" style="padding:0;margin:0;">
                    ...
                    <div class="col-md-10">
                        <div class="list-group-item-heading">
                            ...
                            <p class="pull-right">	Dimensions 146 x 70.6 x 7.6 mm</p>
                            <p style="color:darkblue;">BODY</p>
                            <p class="pull-right">Resolution 1080 x 2340 pixels, 19.5:9 ratio</p>
                            <p style="color:darkblue;">DISPLAY</p>
                            <p class="pull-right">OS Android 12, upgradable to Android 14, One UI 6</p>
                            <p style="color:darkblue;">PLATFORM</p>
                            <p class="pull-right">Internal	128GB 8GB RAM, 256GB 8GB RAM UFS 3.1</p>
